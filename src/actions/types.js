...
export const SET_CURRENT_RESERVATION_STATE = "SET_CURRENT_RESERVATION_STATE";
export const SET_RESERVATION_STEP_STATUS = "SET_RESERVATION_STEP_STATUS";
...
export const SELECT_RETURN_PRICE = "SELECT_RETURN_PRICE";
export const SELECT_DEPART_PRICE = "SELECT_DEPART_PRICE";
